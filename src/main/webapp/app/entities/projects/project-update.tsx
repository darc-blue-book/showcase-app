          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : projectEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="volunteerNumberLabel" for="project-volunteerNumber">
                    Volunteer Number
                  </Label>
                  <AvField id="project-volunteerNumber" type="string" className="form-control" name="volunteerNumber" />
                </AvGroup>
                <AvGroup>
                  <Label id="videoUrlLabel" for="project-videoUrl">
                    Video Url
                  </Label>
                  <AvField id="project-videoUrl" type="text" name="videoUrl" />
                </AvGroup>
                <AvGroup>
